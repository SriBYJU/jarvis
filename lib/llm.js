...
// FAST models: smaller, quicker response for everyday chat
const FAST_MODELS = [
  "openrouter/free",
...
// THINKING models: larger, deeper reasoning for complex tasks
...
// ALL models combined for maximum fallback coverage
const ALL_MODELS = [
  "openrouter/free",
  "deepseek/deepseek-v4-flash:free",
  "meta-llama/llama-3.3-70b-instruct:free",
...
// Strip tool-call XML garbage that some models output (MiniMax, etc.)
...
export async function chatCompletion(messages, systemPrompt, mode = "fast", specificModel = null) {
  ...
  // Try models for the selected mode
